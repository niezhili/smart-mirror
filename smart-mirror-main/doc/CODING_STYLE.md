...
### 3.1 日志使用
- 使用 `loguru` 库进行日志记录
- 每个模块需引入 [logger](file://C:\Users\18870\Desktop\Mirror\fork\smart-mirror\smart-mirror-main\features\face_recognition\face_recognition_system.py#L0-L0) 对象
...
### 4.2 配置使用
- 使用 [config_loader.py](file://C:\Users\18870\Desktop\Mirror\fork\smart-mirror\smart-mirror-main\features\common\config_loader.py) 加载配置
